...
async function EditarEntidadeContratual(req, res) {
  ...
  try {
    ...
    return sendErrorResponse(res, 400, "Falha EditarEntidadeContratual");
  }
}
...
async function updateContract(fields) {
  ...
  const updateDados =
    "UPDATE entidades_contratuais SET nome_simplificado = $1, razao_social = $2, cnpj_cont = $3, cep = $4, endereco = $5, cidade = $6, uf = $7, bairro = $8, complemento = $9, bo_rede = $10 WHERE id = $11 RETURNING *";
