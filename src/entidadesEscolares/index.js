const RegistrarEntidadeEscolarMiddleware = require("./registrarEntidadeEscolar/RegistrarEntidadeEscolar");
const EditarEntidadeEscolarMiddleware = require("./editarEntidadeEscolar/EditarEntidadeEscolar");
const LocalizarEntidadesEscolaresMiddleware = require("./localizarEntidadesEscolares/LocalizarEntidadesEscolares");
const TodasEntidadesEscolaresMiddleware = require("./todasEntidadesEscolares/TodasEntidadesEscolares");
...
module.exports = {
  ...
  LocalizarEntidadesEscolaresMiddleware,
  TodasEntidadesEscolaresMiddleware,
